...
public class SysUserServiceImpl implements ISysUserService {
   ...
   /* @Autowired
    ...
    @Override
    public SysUser selectUserByUserSn(String userSn) {
        return userMapper.selectUserByUserSn(userSn);
    }
    ...
    @Override
    @Transactional
    public void insertUserTemplate(Long userId, Long[] templateIds) {
        templateMapper.deleteUserTemplateByUserId(userId);
        insertUserTemplates(userId, templateIds);
    }
    ...
    @Override
    public List<SysUser> selectUsersById(Long id) {
        List<SysUser> userTemplates = userMapper.selectUsersById(id);
        List<SysUser> userAll = selectUserAll();
        for (SysUser user : userAll) {
            for (SysUser userTemplate : userTemplates) {
                if (user.getUserId().longValue() == userTemplate.getUserId().longValue()) {
                    user.setFlag(true);
                    break;
                }
            }
