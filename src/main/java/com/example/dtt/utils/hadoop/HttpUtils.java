...
public class HttpUtils {
    ...
    static {
        ...
        requestConfig = RequestConfig.custom().setCookieSpec(CookieSpecs.IGNORE_COOKIES)
                ...
                .setConnectTimeout(HttpStatus.HTTP_CONNECT_TIMEOUT).setSocketTimeout(HttpStatus.SOCKET_TIMEOUT)
                .setConnectionRequestTimeout(HttpStatus.HTTP_CONNECTION_REQUEST_TIMEOUT).setRedirectsEnabled(true)
                .build();
    ...
    public static String getResponseContentString(HttpGet httpget, CloseableHttpClient httpClient) {
        ...
        try {
            ...
            if (response.getStatusLine().getStatusCode() == 200) {
                ...
                if (entity != null) {
                    responseContent = EntityUtils.toString(entity, FileConstants.UTF_8);
                } else {
