 ...
 * @describe Excel 转 CSV 工具
 * 该工具为POI用户模式读取上传文件的工具
 * 问题：用户模式读取Excel 数据量大会导致内存溢出
 */
public class FileExcel2CsvUtils {
    ...
    public static String getCellValue(Cell cell) {
        ...
        if (dataFormatString.equals("m/d/yy") && StringUtils.isNotEmpty(dataFormatString) && dataFormatString.matches(Constants.DATA_REGEX)) {
