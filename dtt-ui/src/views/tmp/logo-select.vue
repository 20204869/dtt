...
export default {
    data: function() {
        return {
            ...
            logoData: [
//            {
//                imgSrc: require('../assets/images/360_logo.png')
//            },
//            {
//                imgSrc:require('../assets/images/baidu_logo.png')
//            },
//            {
//                imgSrc:require('../assets/images/sougou_logo.png')
//            }
              {
                imgSrc:logoImg
             }
